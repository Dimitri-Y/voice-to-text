...
const StripePaymentForm = ({ clerkId }: { clerkId: string }) => {
    ...
    return (
        <><h1 className="text-2xl font-bold mb-4 text-center">Free trials have expired (3 trials), further available only in premium version </h1>
            <button
